...
#define STRING_CONFIG_H_AUTHOR                                                 \
  "(Jociclelio, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Estrelinha"
 ...
 * the need for PID_EXTRUSION_SCALING and PID_FAN_SCALING. Use M306 T to
 * autotune the model.
 * @section mpctemp
 */
#if ENABLED(MPCTEMP)
...
#define DEFAULT_ACCELERATION                                                   \
  100 // X, Y, Z and E acceleration for printing moves
...
#define Z_HOMING_HEIGHT 5 // (mm) Minimal Z height before homing (G28)
...
#define LCD_PROBE_Z_RANGE                                                      \
  30 // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
// #define TFT_SHARED_IO    // SPI is shared between TFT display and other
